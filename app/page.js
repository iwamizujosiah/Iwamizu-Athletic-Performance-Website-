export default function Home() {
  ...
  return (
    <main style={{ fontFamily: 'sans-serif', lineHeight: '1.6', backgroundColor: '#000', color: '#fff' }}>
      ...
      <header style={{ padding: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #333' }}>
        ...
        <nav style={{ display: 'flex', gap: '20px' }}>
          ...
          <a href={clientPortalUrl} style={{ color: '#ff0000', fontWeight: 'bold', textDecoration: 'none' }}>Client Portal</a>
          <a href={applicationUrl} style={{ color: '#fff', fontWeight: 'bold', textDecoration: 'none' }}>Apply</a>
        </nav>
      </header>
      ...
      {/* Contact */}
      <section id="contact" style={{ padding: '50px 20px', textAlign: 'center', borderTop: '1px solid #333' }}>
        <h2>Contact</h2>
